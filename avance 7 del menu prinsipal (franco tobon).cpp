...
char clave [MAX]  ;
 ...
 void Crear_Usuario (int num_usuario = 0  ){
     
     int i ;
     

	 printf ("\tPOR FAVOR CREE UN USUARIO\n ");
     printf ("PARA USUARIOS DESEA QUIERE QUE PERMITA ESTE PROGRAMA :  ");
	 ...
	 printf ("\tPor favor cree un nuevo usuario  " );
      printf ("\n");
	 printf ("\nPor favor Digite su nombre de usuario : ",  i +1 );
	 
	 scanf ("%s" , &crear_usuario[1].nombre  );
...
switch (opp_agregar_productos_femeninos ){
	...
	void Salida_Ropa_Masculina  (int opp_salida_ropa_masculida , int opp_salida_camisas_cam_masculinas , int opp_salida_camisa_M_S ,int opp_salida_camisa_M_M  , int opp_salida_camisa_M_L , int opp_salida_pantalones_masculinos , int opp_salida_pantalones_M_18 , int opp_salida_pantalones_M_14 , int opp_salida_pantalones_M_16  ){
	...
	printf ("\n 2) PANTALONES MASCULINOS \n " );	
	

	
	printf ("\n 3)VOLVER \n " );
	scanf("%d" , &opp_salida_ropa_masculida );
	
			 system ("cls");
	switch (opp_salida_ropa_masculida){
	...
	//CAMISAS//
		...
		printf ("CAMISAS MASCULINAS \n" );
		printf ("\n1 ) CAMISAS TALLA S \n" );	
		printf ("\n2 ) CAMISAS TALLA M \n" );	
		printf ("\n3 ) CAMISAS TALLA L \n" );	
		printf ("\n4 ) VOLVER          \n" );		
			scanf ("%d" , &opp_salida_camisas_cam_masculinas);
		 
		 system ("cls");	
	  	switch(opp_salida_camisas_cam_masculinas){
			
			case 1:
			
				 do{
			       
				printf ("CAMISAS MASCULINAS TALLA S \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRAS ESTA CANTIDAD DE CAMISAS TALLA S  %d  \n", RopaM.camisaM_S);
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTAS CAMISAS DESEA ELIMINAR   : ");
				  
				scanf  ("%d", &opp_salida_camisa_M_S);
			  if (  RopaM.camisaM_S  != NULL){
			  	
		   		if  ( opp_salida_camisa_M_S    <=   RopaM.camisaM_S  )  {
				
		    	system ("cls");
		      
				  
				
				 RopaM.camisaM_S =  RopaM.camisaM_S -opp_salida_camisa_M_S;
				 ...
				 ("\n CANTIDAD NO VALIDA  \n");
				  ...
				  printf(" YA NO QUEDAN MAS ARTICULOS  \n");
		...
		case 2 :
				...
				printf ("CAMISAS MASCULINAS TALLA M \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRAS ESTA CANTIDAD DE CAMISAS TALLA M  %d  \n", RopaM.camisaM_M);
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTAS CAMISAS DESEA ELIMINAR   : ");
				  
				scanf  ("%d", &opp_salida_camisa_M_M);
			  if (  RopaM.camisaM_M  != NULL){
			  	
		   		if  ( opp_salida_camisa_M_M    <=   RopaM.camisaM_M  )  {
				
		    	system ("cls");
		      
				  
				
				 RopaM.camisaM_M =  RopaM.camisaM_M -opp_salida_camisa_M_M;
			...
			case 3 :
				...
				printf ("CAMISAS MASCULINAS TALLA L \n");
				...
				scanf  ("%d", &opp_salida_camisa_M_L);
			  if (  RopaM.camisaM_L  != NULL){
			  	
		   		if  ( opp_salida_camisa_M_L    <=   RopaM.camisaM_L )  {
				
		    	system ("cls");
		      
				  
				
				 RopaM.camisaM_L =  RopaM.camisaM_L -opp_salida_camisa_M_L ;
	...
	}while (opp_salida_camisas_cam_masculinas !=  4);
		...
		printf ("PANTALONES MASCULINOS \n" );
		printf ("\n1 ) PANTALONES TALLA 14 \n" );	
		printf ("\n2 ) PANTALONES TALLA 16 \n" );	
		printf ("\n3 ) PANTALONES TALLA 18 \n" );	
		printf ("\n4 ) VOLVER          \n" );		
			scanf ("%d" , &opp_salida_pantalones_masculinos);
		 
		 system ("cls");	
	  	switch(opp_salida_pantalones_masculinos){
			
			case 1:
			
				 do{
			       
				printf ("PANTALONES TALLA 14 \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRAS ESTA CANTIDAD DE PANTALONES TALLA 14  %d  \n",RopaM_P.pantalonM_14  );
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTOS PANTALONES DESEA ELIMINAR   : ");
				  
				scanf  ("%d", & opp_salida_pantalones_M_14);
			  if ( RopaM_P.pantalonM_14 != NULL){
			  	
		   		if  ( opp_salida_pantalones_M_14    <=   RopaM_P.pantalonM_14  )  {
				
		    	system ("cls");
		      
				  
				
				RopaM_P.pantalonM_14 = RopaM_P.pantalonM_14 -opp_salida_pantalones_M_14;
			...
			} while (opp_salida_pantalones_M_14 != 0);
			...
			case 2 :
				...
				printf ("PANTALONES TALLA 16 \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRAS ESTA CANTIDAD DE PANTALONES TALLA 16  %d  \n",RopaM_P.pantalonM_16  );
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTOS PANTALONES DESEA ELIMINAR   : ");
				  
				scanf  ("%d", & opp_salida_pantalones_M_16);
			  if ( RopaM_P.pantalonM_16 != NULL){
			  	
		   		if  ( opp_salida_pantalones_M_16 <=   RopaM_P.pantalonM_16  )  {
				
		    	system ("cls");
		      
				  
				
				RopaM_P.pantalonM_16 = RopaM_P.pantalonM_16 -opp_salida_pantalones_M_16;
			...
			} while (opp_salida_pantalones_M_16 != 0);
			...
			case 3 :
				...
				printf ("PANTALONES TALLA 18 \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRAS ESTA CANTIDAD DE PANTALONES TALLA 18  %d  \n",RopaM_P.pantalonM_18  );
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTOS PANTALONES DESEA ELIMINAR   : ");
				  
				scanf  ("%d", & opp_salida_pantalones_M_18 );
			  if ( RopaM_P.pantalonM_18 != NULL){
			  	
		   		if  ( opp_salida_pantalones_M_18  <=   RopaM_P.pantalonM_18  )  {
				
		    	system ("cls");
		      
				  
				
				RopaM_P.pantalonM_18 = RopaM_P.pantalonM_18 -opp_salida_pantalones_M_18 ;
			...
			} while (opp_salida_pantalones_M_18 != 0);
	...
	}while (opp_salida_pantalones_masculinos !=  4);
...
}while (opp_salida_ropa_masculida !=3);
	...
	void Salida_Ropa_Femenina  (int opp_salida_ropa_femenina , int opp_salida_camisas_cam_femeninas , int opp_salida_camisa_F_S ,int opp_salida_camisa_F_M  , int opp_salida_camisa_F_L , int opp_salida_pantalones_femeninos , int opp_salida_pantalones_F_18 , int opp_salida_pantalones_F_14 , int opp_salida_pantalones_F_16  ){
	...
	printf ("\n ROPA FEMENINA \n " );
	printf ("\n 1) CAMISAS FEMENINAS \n " );
	printf ("\n 2) PANTALONES FEMENINOS \n " );	
	

	
	printf ("\n 3)VOLVER \n " );
	scanf("%d" , &opp_salida_ropa_femenina );
	
			 system ("cls");
	switch (opp_salida_ropa_femenina){
	...
	//CAMISAS//
		...
		printf ("\n3 ) CAMISAS TALLA L \n" );	
		printf ("\n4 ) VOLVER          \n" );		
			scanf ("%d" , &opp_salida_camisas_cam_femeninas);
		 
		 system ("cls");	
	  	switch(opp_salida_camisas_cam_femeninas){
			
			case 1:
			
				 do{
			       
				printf ("CAMISAS FEMENINOS TALLA S \n");
				...
				scanf  ("%d", &opp_salida_camisa_F_S);
			  if (  RopaF.camisaM_S  != NULL){
			  	
		   		if  ( opp_salida_camisa_F_S    <=   RopaF.camisaM_S  )  {
				
		    	system ("cls");
		      
				  
				
				 RopaF.camisaM_S =  RopaF.camisaM_S -opp_salida_camisa_F_S;
		...
		case 2 :
				...
				printf ("CAMISAS FEMENINAS TALLA M \n");
				...
				scanf  ("%d", &opp_salida_camisa_F_M);
			  if (  RopaF.camisaM_M  != NULL){
			  	
		   		if  ( opp_salida_camisa_F_M    <=   RopaF.camisaM_S  )  {
				
		    	system ("cls");
		      
				  
				
				 RopaF.camisaM_M =  RopaF.camisaM_M -opp_salida_camisa_F_M;
			...
			case 3 :
				...
				printf ("CAMISAS FEMENINAS TALLA L \n");
				...
				scanf  ("%d", &opp_salida_camisa_F_L);
			  if (  RopaM.camisaM_L  != NULL){
			  	
		   		if  ( opp_salida_camisa_F_L    <=   RopaF.camisaM_L )  {
				
		    	system ("cls");
		      
				  
				
				 RopaF.camisaM_L =  RopaF.camisaM_L -opp_salida_camisa_F_L ;
	...
	}while (opp_salida_camisas_cam_femeninas !=  4);
		...
		printf ("PANTALONES FEMENINOS \n" );
		printf ("\n1 ) PANTALONES TALLA 14 \n" );	
		printf ("\n2 ) PANTALONES TALLA 16 \n" );	
		printf ("\n3 ) PANTALONES TALLA 18 \n" );	
		printf ("\n4 ) VOLVER          \n" );		
			scanf ("%d" , &opp_salida_pantalones_femeninos);
		 
		 system ("cls");	
	  	switch(opp_salida_pantalones_femeninos){
			
			case 1:
			
				 do{
			       
				printf ("PANTALONES FEMENINOS  TALLA 14 \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRA ESTA CANTIDAD DE PANTALONES TALLA 14  %d  \n" , RopaF_P.pantalonF_14  );
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTOS PANTALONES DESEA ELIMINAR   : ");
				  
				scanf  ("%d", & opp_salida_pantalones_F_14);
				
			  if ( RopaF_P.pantalonF_14 != NULL){
			  	
		   		if  ( opp_salida_pantalones_F_14    <=   RopaF_P.pantalonF_14 )  {
				
		    	system ("cls");
		      
				  
				
				RopaF_P.pantalonF_14 = RopaF_P.pantalonF_14 -opp_salida_pantalones_F_14;
			...
			} while (opp_salida_pantalones_F_14 != 0);
			...
			case 2 :
				...
				printf ("PANTALONES FEMENINOS  TALLA 16 \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRA ESTA CANTIDAD DE PANTALONES TALLA 16  %d  \n" , RopaF_P.pantalonF_16  );
			  ...
			  if ( RopaF_P.pantalonF_16 != NULL){
		   		...
		   		if  ( opp_salida_pantalones_F_16    <=   RopaF_P.pantalonF_16 )  {
				
		    	system ("cls");
		      
				  
				
				RopaF_P.pantalonF_16 = RopaF_P.pantalonF_16 -opp_salida_pantalones_F_16 ;
			...
			} while (opp_salida_pantalones_F_16 != 0);
			...
			case 3 :
				...
				printf ("PANTALONES FEMENINOS TALLA 18 \n");
				
				printf ("\n ACTUALMENTE SE ENCUENTRA ESTA CANTIDAD DE PANTALONES TALLA 18  %d  \n" , RopaF_P.pantalonF_18  );
			
				printf ("\n SELECCIONE 0 PARA SALIR    \n");
				
				printf ("\n CUANTOS PANTALONES DESEA ELIMINAR   : ");
				  
				scanf  ("%d", & opp_salida_pantalones_F_18);
				
			  if ( RopaF_P.pantalonF_18 != NULL){
			  	
		   		if  ( opp_salida_pantalones_F_18    <=   RopaF_P.pantalonF_18 )  {
				
		    	system ("cls");
		      
				  
				
				RopaF_P.pantalonF_18 = RopaF_P.pantalonF_18 -opp_salida_pantalones_F_18;
			...
			} while (opp_salida_pantalones_F_18 != 0);
	...
	}while (opp_salida_pantalones_femeninos !=  4);
...
}while (opp_salida_ropa_femenina !=3);
			...
			do  {
			 ...
			 system ("cls");
    	  	...
    	  	case 3 :
    	  		...
    	  		printf ("\n A QUE TIPO DE ROPA DESEALEMINAR UNA CANTIDAD DE UNIDADES ");
    	  		printf ("\n1 )ROPA MASCULINA  \n");
    	  		printf ("\n2 )ROPA FEMENINA  \n");
    	  		printf ("\n3 )VOLVER ALMENU PRINCIPAL   \n");
    	  		...
    	  		switch (op_salida ){
    	  			...
    	  			case 1 :
    	  				 Salida_Ropa_Masculina  ( opp_salida_ropa_masculida ,  opp_salida_camisas_cam_masculinas ,  opp_salida_camisa_M_S,  opp_salida_camisa_M_M , opp_salida_camisa_M_L , opp_salida_pantalones_M_18 ,  opp_salida_pantalones_masculinas ,  opp_salida_pantalones_M_14 ,  opp_salida_pantalones_M_16 );
    	  				break;
    	  				
    	  			case 2 :
    	  				 Salida_Ropa_Femenina  ( opp_salida_ropa_femenina ,  opp_salida_camisas_cam_femeninas ,  opp_salida_camisa_F_S , opp_salida_camisa_F_M  ,  opp_salida_camisa_F_L ,  opp_salida_pantalones_femeninos ,opp_salida_pantalones_F_18 , opp_salida_pantalones_F_14 ,  opp_salida_pantalones_F_16  );
					  break ;
...
void menu_archivo  ( int op_menu_archivo  , int x , int num ){
...
scanf ("%d", &op_menu_archivo);	
	...
	case 5:
	 ...
	 printf ("\tPor favor cree un nuevo usuario [%d] ", i +1  );
      printf ("\n");
...
Crear_Usuario  ();
    ...
    system ( "cls");
             ...
             system("cls");
 	         ...
 	         printf("\n");
	         printf  (" %s " , crear_usuario[1].nombre)  ;
         printf("\n");
      ...
      while( eleccion!=5) {
         ...
         menu_principal(op_menu_prinsipal ,   op_comprar =0 ,  op_comprar_camisas_Masculinas =0  );
			...
			break;
			 ...
			 menu_archivo (op_menu_archivo , x  , num );
